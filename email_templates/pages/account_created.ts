...
<div style="display:flex;justify-content:center">
  <table width="100%" style="max-width:900px">
    <tr>
      <td><img src="https://images2.imgbox.com/d4/bf/rTNABwbr_o.jpg" alt="Gibson Lake Copper Art"
...
<h4
  ...
  Welcome ${props.first_name}, to Gibson Lake Copper Art</h4>
<p style="font-size:16px;line-height:30px;max-width:800px;width:100%;margin:20px auto;color:white">Here at
  Copper-rt.com we strive to bring as much light in to as many lives as possible. All items are handmade at my
...
<div style="display:flex;justify-content:center"><a href="http://www.glow-leds.com/" alt="discount image"
    ...
    <h4 style="font-family:helvetica;margin:0;font-size:1.2em;text-align:center">Shop with Gibson Lake Copper Art Today!</h4>
  </a></div>
</div>
