export default (props: any) => {
  ...
  <div style="background-color:#5f5f5f;padding:20px">
        ...
        <p
          ...
          Your Password Was Successfully Changed. If you didn’t request this, please contact Gibson Lake Copper Art using the link
          below.</p>
        <div style="display:flex;justify-content:center"><a href="https://www.copper-rt.com/pages/contact"
