	...
	return (
		<div className="main_container">
			<Helmet>
				...
				<link rel="canonical" href="http://www.copper-rt.com/pages/contact" />
				<meta property="og:url" content="http://www.copper-rt.com/pages/contact" />
				<meta
					name="description"
					...
					{[ 'submit_content_to_be_featured' ].includes(reason_for_contact) && (
						<div>
							...
							<ol style={{ paddingLeft: '20px' }}>
								...
								<li>For "Email To" put info.copper.rt@gmail.com</li>
